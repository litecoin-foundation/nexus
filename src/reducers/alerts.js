...
// actions
export const addAlert = (data) => async (dispatch, getState) => {
...
export const removeAlert = (index) => async (dispatch, getState) => {
  const req = await fetch(
...
export const setAlertAvailability = (index, availability) => async (dispatch, getState) => {
  const req = await fetch(
